      ...
      <div className="editorial-container py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-[260px] text-small text-ink-muted">
              An AI interviewer that reads your résumé, hears every pause, and
              asks the follow-ups a real hiring manager would.
            </p>
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div key={heading}>
              <Eyebrow className="text-ink">{heading}</Eyebrow>
        ...
        <HairlineDivider className="mt-12 mb-8" />

        <div className="flex flex-col gap-4 text-eyebrow text-ink-muted md:flex-row md:items-center md:justify-between">
          <span className="font-mono">
            © {year} REHEARSAL — A REHEARSAL ROOM FOR INTERVIEWS
          </span>
